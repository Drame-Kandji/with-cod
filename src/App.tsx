  ...
  const services = [
    {
      ...
      description:
        "Conception et réalisation complète de vos projets de construction résidentiels et commerciaux.",
      image: service1,
    },
    {
      icon: Hammer,
      ...
      description:
        "Élaboration de plans détaillés et dimensionnement structurel pour tous types de bâtiments.",
      image: service2,
    },
    {
      icon: Code,
      ...
      description:
        "Création de sites web modernes, responsive et optimisés pour votre présence en ligne.",
      image: service3,
    },
    {
      icon: Database,
      ...
      description:
        "Solutions logicielles sur mesure pour la gestion de stocks, clients et activités.",
      image: service4,
    },
    {
      icon: LineChart,
      ...
      description:
        "Tableaux de bord interactifs, reporting en temps réel et gestion collaborative.",
      image: service5,
    },
    {
      icon: Wrench,
  ...
  return (
    ...
    >
      <div className="min-h-screen bg-white dark:bg-gray-900">
          ...
          <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-16">
              ...
              <div className="hidden md:flex items-center space-x-8">
                <a
                  href="#accueil"
                  className="text-gray-700 dark:text-gray-300 hover:text-amber-700 dark:hover:text-amber-500 transition-colors font-medium text-sm"
                >
                  Accueil
                </a>
                <a
                ...
                <a
                  href="#contact"
                  className="bg-amber-700 text-white px-5 py-2 rounded-lg hover:bg-amber-800 transition-colors font-medium text-sm"
                >
                  Contact
                </a>
                <button
            ...
            {isMenuOpen && (
              <div className="md:hidden py-4 space-y-3 border-t dark:border-gray-800">
                <a
                  href="#accueil"
                  className="block text-gray-700 dark:text-gray-300 hover:text-amber-700 dark:hover:text-amber-500 transition-colors font-medium text-sm"
                >
                  Accueil
                </a>
                <a
                ...
                <a
                  href="#contact"
                  className="block bg-amber-700 text-white px-5 py-2 rounded-lg hover:bg-amber-800 transition-colors font-medium text-sm text-center"
                >
                  Contact
                </a>
              </div>
        ...
        <section
          id="accueil"
          className="pt-24 pb-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-amber-50 to-white dark:from-gray-800 dark:to-gray-900 transition-colors duration-300"
        >
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                ...
                <p className="text-lg text-gray-600 dark:text-gray-400 leading-relaxed">
                  Nous combinons l'expertise en construction avec les
                  technologies modernes pour transformer vos projets en réalité.
                  Solutions complètes pour particuliers, entreprises et
                  organisations.
                </p>
                <div className="flex flex-col sm:flex-row gap-4 pt-4">
                  <a
                    href="#contact"
                    className="inline-flex items-center justify-center bg-amber-700 text-white px-6 py-3 rounded-lg hover:bg-amber-800 transition-all transform hover:scale-105 font-medium text-sm shadow-lg"
                  >
                    Démarrer un Projet
                  </a>
                  <a
                    href="#services"
                    className="inline-flex items-center justify-center border-2 border-amber-700 dark:border-amber-600 text-amber-700 dark:text-amber-500 px-6 py-3 rounded-lg hover:bg-amber-50 dark:hover:bg-gray-800 transition-colors font-medium text-sm"
                  >
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
                Une gamme complète de services alliant construction
                traditionnelle et innovation numérique
              </p>
            </div>
        ...
        <section
          id="apropos"
          className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-amber-50 to-white dark:from-gray-800 dark:to-gray-900 transition-colors duration-300"
        >
          <div className="max-w-7xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                ...
                <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed">
                  Devenir une référence parmi les entreprises locales qui
                  associent construction et technologie pour proposer des
                  solutions modernes, accessibles et de qualité.
                </p>
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                  Nous proposons des plans architecturaux et le dimensionnement
                  de toutes vos structures avec un accompagnement personnalisé
                ...
                <div className="space-y-4 pt-4">
                  {avantages.map((avantage, index) => (
                    <div
                      key={index}
                      className="flex items-start space-x-3 bg-white dark:bg-gray-800 p-4 rounded-xl border border-amber-100 dark:border-gray-700"
                    >
              ...
              <div className="space-y-6">
                <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-xl border border-amber-100 dark:border-gray-700">
                  ...
                  <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                    Offrir des services pratiques, fiables et innovants qui
                    allient savoir-faire technique et outils numériques pour
